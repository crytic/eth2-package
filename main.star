...
genesis_constants = import_module("./eth-network-package/src/prelaunch_data_generator/genesis_constants/genesis_constants.star")

eth_network_module = import_module("./eth-network-package/main.star")
